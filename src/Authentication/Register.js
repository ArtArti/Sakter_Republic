...
export default function SingIn() {
  ...
  return (
    <>
      ...
      >
        <div className=" mt-20 bg-transparent w-full max-w-sm p-4 border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
          <form className=" space-y-3 text-lg font-bold">
